# Form implementation generated from reading ui file 'C:\Users\byzan\PycharmProjects\UI Files\Neural_Network_View.ui'
#
...
class Neural_Network_View(object):
...
"}")
        ...
        self.general_group.setGeometry(QtCore.QRect(40, -10, 431, 301))
        ...
        self.formLayoutWidget_12.setGeometry(QtCore.QRect(30, 120, 173, 157))
        ...
        self.general_form.setWidget(0, QtWidgets.QFormLayout.ItemRole.LabelRole, self.layers_label)
        ...
        self.general_form.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.layers_entry)
        ...
        self.formLayoutWidget_15.setGeometry(QtCore.QRect(200, 120, 301, 157))
        ...
        self.general_form_2.setWidget(2, QtWidgets.QFormLayout.ItemRole.LabelRole, self.categories_label)
        ...
        self.general_form_2.setWidget(2, QtWidgets.QFormLayout.ItemRole.FieldRole, self.categories_entry)
        self.task_label = QtWidgets.QLabel(parent=self.formLayoutWidget_15)
        self.task_label.setObjectName("task_label")
        self.general_form_2.setWidget(0, QtWidgets.QFormLayout.ItemRole.LabelRole, self.task_label)
        self.task_entry = QtWidgets.QComboBox(parent=self.formLayoutWidget_15)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.task_entry.sizePolicy().hasHeightForWidth())
        self.task_entry.setSizePolicy(sizePolicy)
        self.task_entry.setMinimumSize(QtCore.QSize(112, 0))
        self.task_entry.setObjectName("task_entry")
        self.general_form_2.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.task_entry)
        self.layers_tab = QtWidgets.QTabWidget(parent=self.fields_frame)
        self.layers_tab.setGeometry(QtCore.QRect(40, 290, 431, 591))
        font = QtGui.QFont()
        ...
        self.formLayoutWidget_3.setGeometry(QtCore.QRect(30, 10, 401, 572))
        ...
        self.formLayoutWidget_11.setGeometry(QtCore.QRect(20, 360, 381, 221))
        ...
        self.formLayoutWidget_13.setGeometry(QtCore.QRect(20, 360, 381, 210))
        ...
        self.formLayoutWidget_14.setGeometry(QtCore.QRect(20, 360, 381, 210))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.task_label.setText(_translate("MainWindow", "Task Type"))
